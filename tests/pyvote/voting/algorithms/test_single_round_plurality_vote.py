...
class TestSingleRoundPluralityVote:
    ...
    candidates = [
        Candidate(name="Ted", popularity=1.0),
        Candidate(name="Winnie", popularity=1.0),
    ]
    ...
    def test_constructor_when_given_all_arguments_expect_to_work(self):
        ...
        assert voting._candidates[0].popularity == 0.5  # noqa: PLR2004
        assert voting._candidates[1].popularity == 0.5  # noqa: PLR2004
